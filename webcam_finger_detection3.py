            ...
            for idx, hand_landmarks in enumerate(results.multi_hand_landmarks):
                ...
                if distance < 70:
                    if results.multi_handedness[idx].classification[0].label == "Right":
                        cv2.putText(image, 'right-finger touch !!', (image_width - 700, 70), cv2.FONT_HERSHEY_SIMPLEX, 2, (255, 255, 0), 2, cv2.LINE_AA)
                    elif results.multi_handedness[idx].classification[0].label == "Left":
                        cv2.putText(image, 'left-finger touch !!', (20, 70), cv2.FONT_HERSHEY_SIMPLEX, 2, (0, 0, 255), 2, cv2.LINE_AA)
